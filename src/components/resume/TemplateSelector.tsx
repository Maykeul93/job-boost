  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-lg font-medium text-gray-900">Choisissez votre template</h3>
        <p className="mt-1 text-sm text-gray-500">
          Sélectionnez le style qui correspond le mieux à votre personnalité et au poste visé
        </p>
      </div>
      ...
      <div className="text-center text-sm text-gray-500">
        <p>
          💡 <strong>Conseil :</strong> Choisissez un template qui correspond à votre secteur d'activité
        </p>
        <p className="mt-1">
          Les templates Premium offrent plus d'options de personnalisation
        </p>
      </div>
    </div>
  );
